package com.zenkun.smsenhancer.controls;

import com.zenkun.smsenhancer.Log;
import com.zenkun.smsenhancer.R;
import com.zenkun.smsenhancer.SmsMmsMessage;
import com.zenkun.smsenhancer.SmsPopupActivity;
  ...
  private void setupLayout(Context context) {
   ...
   // Find the ImageView that will show the contact photo
	...
	public void onClick(View v) {
    	  getContext().startActivity(SmsPopupUtils.getSmsInboxIntent());
