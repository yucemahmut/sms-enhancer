...
public class ConfigPerContactActivity extends PreferenceActivity {
  ...
  public static final String EXTRA_CONTACT_ID =
    "com.zenkun.smsenhancer.EXTRA_CONTACT_ID";
  ...
  private boolean storePreferences(Preference preference, Object newValue) {
    ...
    String column = null;
    boolean isPlus = License.isPlusVersion(getApplicationContext());
    ...
    //smsenhancerBD
    } else if (key.equals(getString(R.string.c_pref_keywords_key)) && isPlus) {
        column = SmsPopupDbAdapter.KEY_KEYWORDS_ENABLE;
    } else if (key.equals(getString(R.string.c_pref_keywordslist_key))&& isPlus) {
        column = SmsPopupDbAdapter.KEY_KEYWORDS_LIST;
    } else if (key.equals(getString(R.string.c_pref_keywordslistNotification_key))&& isPlus) {
        column = SmsPopupDbAdapter.KEY_KEYWORDS_NOTIF;
    } else if (key.equals(getString(R.string.c_pref_keywords_enablecustommsg_key))&& isPlus) {
        column = SmsPopupDbAdapter.KEY_KEYWORDS_CUSTOMMSG_ENABLE;
    } else if (key.equals(getString(R.string.c_pref_keywords_custommsg_key))&& isPlus) {
        column = SmsPopupDbAdapter.KEY_KEYWORDS_CUSTOMMSG;
    } else if (key.equals(getString(R.string.c_pref_keywords_custommsg_popup_key))&& isPlus) {
        column = SmsPopupDbAdapter.KEY_KEYWORDS_SHOWPOPUP;
    } else if (key.equals(getString(R.string.c_pref_keywords_htcsecurebox_key))&& isPlus) {
        column = SmsPopupDbAdapter.KEY_KEYWORDS_HTCSECURE;
    } else {
      return false;
    }
  ...
  private void retrievePreferences(Cursor c) {
    ...
    editor.putBoolean(getString(R.string.c_pref_keywords_key),
            one.equals(c.getString(SmsPopupDbAdapter.KEY_KEYWORDS_ENABLE_NUM)));
    editor.putString(getString(R.string.c_pref_keywordslist_key),
            c.getString(SmsPopupDbAdapter.KEY_KEYWORDS_LIST_NUM));
    editor.putBoolean(getString(R.string.c_pref_keywordslistNotification_key),
            one.equals(c.getString(SmsPopupDbAdapter.KEY_KEYWORDS_NOTIF_NUM)));
    editor.putBoolean(getString(R.string.c_pref_keywords_enablecustommsg_key),
            one.equals(c.getString(SmsPopupDbAdapter.KEY_KEYWORDS_CUSTOMMSG_ENABLE_NUM)));
    editor.putString(getString(R.string.c_pref_keywords_custommsg_key),
            c.getString(SmsPopupDbAdapter.KEY_KEYWORDS_CUSTOMMSG_NUM));
    editor.putBoolean(getString(R.string.c_pref_keywords_custommsg_popup_key),
            one.equals(c.getString(SmsPopupDbAdapter.KEY_KEYWORDS_SHOWPOPUP_NUM)));
    editor.putBoolean(getString(R.string.c_pref_keywords_htcsecurebox_key),
            one.equals(c.getString(SmsPopupDbAdapter.KEY_KEYWORDS_HTCSECURE_NUM)));
  }
