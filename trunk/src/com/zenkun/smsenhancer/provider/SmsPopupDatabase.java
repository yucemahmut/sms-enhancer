...
public class SmsPopupDatabase extends SQLiteOpenHelper {
    ...
    private static final String CONTACTS_DB_CREATE =
        ...
        //smsenhancer fields
        ContactNotifications.KEY_KEYWORDS_ENABLE    + " integer default 0 ," +
        ContactNotifications.KEY_KEYWORDS_LIST      + " text default '' ," +
        ContactNotifications.KEY_KEYWORDS_NOTIF     + " integer default 1 ," +
        ContactNotifications.KEY_KEYWORDS_CUSTOMMSG_ENABLE  + " integer default 0 ," +
        ContactNotifications.KEY_KEYWORDS_CUSTOMMSG + " text default '' ," +
        ContactNotifications.KEY_KEYWORDS_SHOWPOPUP + " integer default 0 ," +
        ContactNotifications.KEY_KEYWORDS_HTCSECURE + " integer default 0 ," +
