...
public class SmsReceiverService extends Service {
  ...
  private static final String ACTION_MESSAGE_RECEIVED = "com.zenkun.smsenhancer.MESSAGE_RECEIVED";
  ...
  private void notifyMessageReceived(SmsMmsMessage message) {
    ...
    if(exist)
    {
	    notifEnabled = mPrefs.getBoolean(R.string.pref_keywordslistNotification_key
			   , Defaults.PREFS_KEYWORDS_NOTIFICATIONS_ENABLE,SmsPopupDbAdapter.KEY_KEYWORDS_NOTIF_NUM);
	    message.KeywordsNotification(notifEnabled);
	    
	     showPopup = mPrefs.getBoolean(R.string.pref_keywords_custommsg_popup_key, 
	    		Defaults.PREFS_KEYWORDS_CUSTOM_MSG_POPUP_ENABLE,SmsPopupDbAdapter.KEY_KEYWORDS_SHOWPOPUP_NUM);
    ...
    if (showPopup && callStateIdle && !docked
      ...
      if (Log.DEBUG) Log.v("^^^^^^Showing  Popup");
      ...
      if (Log.DEBUG) Log.v("^^^^^^Not showing Popup, using notifications");
