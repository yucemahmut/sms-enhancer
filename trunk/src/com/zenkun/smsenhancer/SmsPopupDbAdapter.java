...
public class SmsPopupDbAdapter {
  ...
  //smsenhancer
  public static final String KEY_KEYWORDS_ENABLE          = "keywords_enable";
  public static final int   KEY_KEYWORDS_ENABLE_NUM       = 14;
  public static final String KEY_KEYWORDS_LIST            = "keyword_list";
  public static final int   KEY_KEYWORDS_LIST_NUM         = 15;
  public static final String KEY_KEYWORDS_NOTIF           = "keywords_notifications";
  public static final int   KEY_KEYWORDS_NOTIF_NUM        = 16;
  public static final String KEY_KEYWORDS_CUSTOMMSG_ENABLE = "enable_custom_message";
  public static final int   KEY_KEYWORDS_CUSTOMMSG_ENABLE_NUM = 17;
  public static final String KEY_KEYWORDS_CUSTOMMSG           = "custom_message";
  public static final int   KEY_KEYWORDS_CUSTOMMSG_NUM      = 18;
  public static final String KEY_KEYWORDS_SHOWPOPUP        = "keywords_showpopup";
  public static final int   KEY_KEYWORDS_SHOWPOPUP_NUM     = 19;
  public static final String KEY_KEYWORDS_HTCSECURE        = "keywords_htcsecure";
  public static final int   KEY_KEYWORDS_HTCSECURE_NUM     = 20;
  ...
  private static final String CONTACTS_DB_CREATE =
    ...
    //smsenhancer fields
    KEY_KEYWORDS_ENABLE        + " integer default 0 ," +
    KEY_KEYWORDS_LIST        + " text default '' ," +
    KEY_KEYWORDS_NOTIF        + " integer default 1 ," +
    KEY_KEYWORDS_CUSTOMMSG_ENABLE  + " integer default 0 ," +
    KEY_KEYWORDS_CUSTOMMSG  + " text default '' ," +
    KEY_KEYWORDS_SHOWPOPUP  + " integer default 0 ," +
    KEY_KEYWORDS_HTCSECURE  + " integer default 0 " +
    ");";
  ...
  private static class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
      ...
      db.execSQL("ALTER TABLE "+CONTACTS_DB_TABLE +" ADD COLUMN keywords_htcsecure integer NULL DEFAULT 0;");
  ...
  public boolean updateContactSummary(long contactId) {
    ...
    if(one.equals(contact.getString(KEY_KEYWORDS_ENABLE_NUM)))
    {
    	summary.append(", Keywords ON");
    }
    contact.close();
